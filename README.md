...
| **OWASP LLM Top 10** | Prompt Injection → Model Overreliance |
| **MITRE ATLAS** | Adversarial threat matrix for AI/ML systems |
| **EU AI Act** | Risk-based regulatory compliance |
...
| Module | Level | Hours |
|---|---|---|
| 1. AI Fundamentals | Beginner | 4h |
| 2. Machine Learning Fundamentals | Beginner | 5h |
| 3. AI System Architecture | Intermediate | 6h |
| 4. AI Security Fundamentals | Intermediate | 6h |
| 5. AI Threat Landscape | Intermediate | 5h |
| 6. AI Attack Types | Advanced | 8h |

---

## 🎓 Role-Based Learning Tracks

| Role | Modules | Certification |
|---|---|---|
| Beginner | 1–2 | AI Security Foundations |
| Security Analyst | 1, 2, 4, 5 | AI Security Analyst |
| AI Engineer | 1–3, 6 | Secure AI Engineering |
| AI Security Engineer | 1–6 | AI Security Engineer Pro |
| Security Architect | 3–6 | AI Security Architect |
| CISO | 5–6 | AI Security Leadership |
